...
{
protected:
	virtual Result<Out> eval() { return Result<Out>::fail(); }
};

// This is to skirt around template argument deduction being absent for Class templates.
template <typename In, typename Out>
typename std::shared_ptr<IParser<In, Out>> fail()
{
